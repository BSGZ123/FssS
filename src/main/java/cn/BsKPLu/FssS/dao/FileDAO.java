...
import cn.BsKPLu.FssS.entity.File;
import cn.BsKPLu.FssS.model.BaseAuthRecord;
import cn.BsKPLu.FssS.model.FileBasicRecord;
import cn.BsKPLu.FssS.model.FileRecord;
import cn.BsKPLu.FssS.dao.sqlprovider.FileSqlProvider;
...
public interface FileDAO {
    ...
    @SelectProvider(type=FileSqlProvider.class,method = "tagSearch")
    List<FileRecord> fileTagSearch(@Param("tag") String tag);
    /**
     * 获取用户的上传资源
     *
     * @param userId 用户编号

...
public class ConfigServiceImpl implements IConfigService {
    ...
    public String getGlobalConfig() {
        JSONObject jsonObject = (JSONObject) FssSApplication.settings.getObjectUseEval(ConfigConsts
    ...
    public String getUserConfig() {
        JSONObject jsonObject = (JSONObject) FssSApplication.settings.getObjectUseEval(ConfigConsts.USER_OF_SETTINGS)
                .clone();
